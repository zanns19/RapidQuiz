      ...
      <div className="hidden lg:flex lg:w-5/12 relative bg-[#0B2A2A] text-[#EEF2F6] flex-col justify-between p-12 overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          >
            ...
            where your
            <br />
            <span className="text-[#FF5A36]">last class left off.</span>
          </h1>
          <p className="text-[#9FC5C0] text-sm max-w-xs leading-relaxed">
            Sign in to launch a quiz, watch submissions come in live, and
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label htmlFor="password" className="block text-sm font-medium text-[#0B2027]">
                  Password
                </label>
                <a href="/forgot-password" className="text-xs text-[#0B6E4F] hover:underline">
                  Forgot password?
                </a>
              </div>
